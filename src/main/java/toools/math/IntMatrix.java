...
public class IntMatrix
{
	...
	public static IntMatrix multiplication(IntMatrix ma, IntMatrix mb)
	{
		assert ma.width == mb.height;

		IntMatrix m = new IntMatrix(ma.width, mb.height);
