...
public class CompoundLongPredicate implements LongPredicate
{
	...
	// there's an order because the user may want to apply filter before others
	// for example filters involving network communications will be invoked as
	// late as possible
