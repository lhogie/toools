 ...
 * is implemented using a two-dimensional double array: [x, x, x, x, x] [x, x,
...
public class DoubleMatrix
{
	...
	public DoubleMatrix(double[][] tab)
	{
		height = tab.length;
		width = tab[0].length;
	...
	public void setColumn(int i, double[] c)
	{
		assert i >= 0 : i;
		assert i < width : i;
	...
	public static DoubleMatrix multiplication(DoubleMatrix ma, DoubleMatrix mb)
	{
		assert ma.width == mb.height;

		DoubleMatrix m = new DoubleMatrix(ma.width, mb.height);
	...
	{
		DoubleMatrix m = new DoubleMatrix(3, 2);
