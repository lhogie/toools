...
public class Interval
{
    ...
    public Interval(double lowerBound, double upperBound, boolean includeLowerBound, boolean includeUpperBound)
    {
	...
	if (numbers.length == 2)
	{
	    return new Interval(Double.valueOf(numbers[0]), Double.valueOf(numbers[1]), s.startsWith("["),
		    s.endsWith("]"));
	}
	else
	{
    ...
    {
	return (includeLowerBound ? "[" : "]") + lowerBound + " " + upperBound + (!includeUpperBound ? "[" : "]");
    }
